  ...
  return (
    ...
    <main className={`p-4 flex justify-center min-h-screen dark:bg-zinc-900`}>
        <div className={`w-[50rem] max-lg:w-full h-[100%] dark:bg-zinc-900 animate-fade-in`}>
					<h1 className={`text-4xl mb-4 pb-4 text-[#485caa] font-semibold text-center border-b-2 dark:bg-zinc-900 dark:text-zinc-200 dark:border-zinc-400`}>Habilidades</h1>
					<p className={`my-2 text-[#213547] dark:bg-zinc-900 dark:text-zinc-100`}>Estas son las tecnologías con las que trabajo para llevar a cabo mis proyectos.</p>
