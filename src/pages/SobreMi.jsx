		...
		<main className={`p-4  min-h-screen `}>
			...
			<VerticalTimeline className={"z-0 "}>
				<VerticalTimelineElement
					...
					dateClassName='text-black dark:text-black'
					contentStyle={{ "border": "1px solid rgb(33, 150, 243)"}}
					contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }}
					iconStyle={{ background: 'rgb(33, 150, 243)' }}
					icon={<HomeIcon className="text-white bg-transparent " />}
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Análisis en Sistemas</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Inicio de carrera</h4>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Codo a Codo</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Curso Fullstack</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Informática Aplicada</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Segunda carrera</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">APP de Países</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Desarrollo de aplicación</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Digital Corner</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Aplicación Web</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">No Country</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Desarrollador Frontend</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Hackathon Justina.IO</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Hackathon</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Alura Latam</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Formación Java & Spring Boot</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Análisis de Sistemas</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Título de Técnico</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">IcarisTech</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Desarrollador Web</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
				...
				<VerticalTimelineElement
					...
					icon={<GraduationCapIcon className=' bg-transparent text-white' />}
				>
					<h3 className="vertical-timeline-element-title text-zinc-900 dark:text-zinc-900">Licenciatura en Ciencia de Datos</h3>
					<h4 className="vertical-timeline-element-subtitle text-zinc-900 dark:text-zinc-900">Futuro Académico</h4>
					<p className='text-zinc-900 dark:text-zinc-900'>
