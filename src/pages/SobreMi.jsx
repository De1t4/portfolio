...
export default function SobreMi() {
  ...
  return (
		<main className={`p-4    dark:bg-zinc-900`}>
			...
			<section className={`dark:bg-zinc-900 w-[50rem] flex flex-col items-center m-auto`}>
				<div className={`flex items-center m-auto my-20 gap-8 max-md:flex-col-reverse max-lg:w-auto max-md:my-10   dark:bg-zinc-900`}>
					<div className={`w-[40rem] max-lg:w-2/4 max-md:w-auto   dark:bg-zinc-900`}>
						<h1 className={`text-[#213547] text-3xl text-left my-4 font-semibold max-md:text-center  dark:bg-zinc-900 dark:text-zinc-100`}>{t("experience")}</h1>
						<p className={`text-[#213547] text-left max-md:text-left space-x-6 text-md font-[400] max-md:my-4  dark:bg-zinc-900 dark:text-zinc-100`}>
						{t("text3")}</p>
					</div>
					<img src={"desarrollador-front-end.jpg"} alt="" className={`w-[25rem] h-[15rem]   dark:bg-zinc-900`} />
				</div>
