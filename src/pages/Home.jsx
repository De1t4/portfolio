    ...
    <>
		<main className={`min-h-screen  dark:bg-zinc-900`}>
				<section className={`flex w-[50rem] m-auto flex-col max-lg:w-auto dark:bg-zinc-900 `}>
					<div className={`flex items-center gap-8 border-b-2 p-8 max-lg:flex-col max-md:flex-col dark:bg-zinc-900 dark:border-zinc-500`}>
							<img src={"img.png"} alt="mi foto" className=' w-[18rem] rounded-full h-[18rem] duration-300 transition-all animate-fade-in'/>
