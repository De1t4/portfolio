		...
		<main className={`min-h-screen  dark:bg-zinc-900`}>
				<section className={`flex w-[50rem] m-auto flex-col max-lg:w-auto dark:bg-zinc-900 `}>
					<div className={`flex items-center gap-8 border-b-2 p-8 max-md:flex-col dark:bg-zinc-900 dark:border-zinc-500`}>
							...
							<h1 className={`text-4xl leading-[3rem] max-lg:text-center dark:bg-zinc-900 dark:text-zinc-100`}>Un gusto. Soy<span className={`text-[#485caa] font-semibold cursor-pointer hover:brightness-110 dark:bg-zinc-900`}> Mauricio Chambi</span>. Estudiante de Análisis en Sistemas</h1>
					</div>
					...
					<div className={`flex justify-around mb-8 dark:bg-zinc-900`}>
						<span className='flex flex-col items-center dark:bg-zinc-900 text-zinc-100'>
							...
							<p className='dark:bg-zinc-900 text-zinc-100'>Email</p>
						</span>
						{links.map(({href, iconClass, text})=>(
							<span className='flex flex-col items-center dark:bg-zinc-900 text-zinc-100'>
								<a href={href} target='_blank' key={text} className={`dark:bg-zinc-900`}>
									{iconClass}
								</a>
								<p className='dark:bg-zinc-900 text-zinc-100'>{text}</p>
							</span>
