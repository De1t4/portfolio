...
export const ProyectosProps = (props) => {
  ...
  return (
    <>
    <div className={`border-2 border-zinc-500 p-4 rounded-lg my-4 dark:bg-zinc-900 dark:border-gray-600`}>
        ...
        <h1 className={`mt-2 font-semibold dark:bg-zinc-900 dark:text-zinc-100`}>{props.nombre}</h1>
        <p className={`text-[#213547] border-y-2 my-2 text-justify dark:bg-zinc-900 dark:text-zinc-100 dark:border-gray-600`}>{props.descripcion}</p>
