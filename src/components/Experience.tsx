        ...
        >
          {experiences.map((exp, index) => (
            <motion.div
              ...
              key={index}
              className="bg-gray-800 px-12 py-8 max-md:px-8 rounded-md border-gray-700 hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300"
            >
              <a href={exp.link} target="_blank" >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="">
                    ...
                    <span className="border-gray-600 text-gray-300 font-bold">
                      {exp.type}
                    </span>
                  </div>
                  <div className=" flex flex-col items-end max-md:items-start flex-wrap text-right  gap-2 text-md text-gray-400">
